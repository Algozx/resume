...
import $ from "jquery";
import CV from "../assets/pdf/guilherme_resume.pdf";
import { Link } from "react-router-dom";

const Home = () => {
  const firstTexts = ["Game Developer", "Unity Developer", "Unreal Engine Developer"];
  const secondTexts = [
    "Game Developer",
    "Unity Developer",
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          ...
          <h3 className="fade_up">
            Guilherme <span>Montesano</span>
          </h3>
          <h2 className="designer fade_up">{firstTexts[firstTextIndex]}</h2>
          <div className="profile-media-icons-main fade_up">
            <Link to="mailto:guilherme.montesano@gmail.com" className="profile-media-icons">
              <img src={EmailSvg} alt="email-svg" />
            </Link>
            <Link to="https://linkedin.com/in/guilhermemontesano" className="profile-media-icons">
