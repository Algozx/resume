      ...
      case 'image':
        const imageElement = (
          <img
            ...
            style={{ width: '100%', height: 'auto', marginBottom: '1rem', cursor: block.link ? 'pointer' : 'default' }} // Adicionei um estilo básico
          />
        );
        
        // Se houver um link, envolve a imagem em um <a> tag
        if (block.link) {
          return (
            <a key={index} href={block.link} target="_blank" rel="noopener noreferrer">
              {imageElement}
            </a>
          );
        }
